...
const db = new better_sqlite3_1.default(process.env.DB_PATH || "cartela.db");
...
const creditTxn = db.transaction((telegramId, amountCents, type, reference) => {
...
const debitTxn = db.transaction((telegramId, amountCents, type, reference) => {
...
const recordGameTxn = db.transaction((g) => {
